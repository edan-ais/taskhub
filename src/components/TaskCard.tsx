      ...
      <div className="absolute top-2 right-2 flex gap-1 items-center">
        {task.lane === 'red' && (
          <button
            ...
            className="p-1.5 hover:bg-yellow-100 rounded border border-yellow-500 bg-white transition-colors"
        ...
        {task.lane === 'yellow' && (
          <>
            <button
              ...
              className="p-1.5 hover:bg-red-100 rounded border border-red-500 bg-white transition-colors"
            ...
            <button
              ...
              className="p-1.5 hover:bg-green-100 rounded border border-green-500 bg-white transition-colors"
